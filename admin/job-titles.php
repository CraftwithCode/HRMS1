<?php
	...
	if(isset($_SESSION['main']['gid'])){
		$key = $_SESSION['main']['gid'].'_job_titles';
	} else {
	...
	try {
		...
		if(isset($_GET['edit'])){
			$edit = $_GET['edit'];
			$emp = $con->prepare('SELECT * from job_titles where id=:edit');
			...
			<div class="col-sm-12">
				<div class="box box-info">
					<div class="box-header">
						<i class="fa fa-user-plus"></i> <h3 class="box-title">Job Titles</h3>
						<!-- tools box -->
						<div class="pull-right box-tools">
							<a href="<?='/hrms/admin/manage-job-titles.php'?>" class="btn btn-primary">Go Back</a>
					...
					<div class="box-body">
						<div class="col-sm-12">
							<form id="job-titles" name="job_titles" method="post" action="" class="job-titles ar-forms">
								<input type="hidden" name="formtype" value="job-titles">
