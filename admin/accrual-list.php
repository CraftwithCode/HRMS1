			...
			<div class="col-sm-12">
				<div class="box box-info">
					<div class="box-header">
						...
						<div class="pull-right box-title"><a href="/hrms/admin/accruals.php" class="">Add New</a></div>
						<!-- tools box -->
					...
					<div class="box-body">
						<div class="col-sm-12">
							<form class="filter-accrual" method="post">
						...
						<div class="col-sm-12 view-iframe-div">
							<iframe src="/hrms/admin/accrual-listview.php" class="view-iframe" style="width: 100%"></iframe>							
						</div>
					</div>
				</div>
			</div>
