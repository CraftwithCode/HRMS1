...
<div class="content-wrapper">
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">Requested Accruals</li>
		</ol>
	</section>
			...
			<div class="col-sm-12">
				<div class="box box-info">
					<div class="box-header">
						<i class="fa fa-user-plus"></i> <h3 class="box-title">Requested Accruals</h3>
					...
					<div class="box-body">
						<div class="col-sm-12">
							<form class="filter-accrualreq" method="post">
						...
						<div class="col-sm-12 view-iframe-div">
							<iframe src="/hrms/admin/viewaccrual-request.php" class="view-iframe" style="width: 100%"></iframe>							
						</div>
					</div>
				</div>
			</div>
