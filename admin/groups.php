<?php
	...
	try {
		...
		if(isset($_GET['edit'])){
			$edit = $_GET['edit'];
			$emp = $con->prepare('SELECT * from groups where id=:edit');
			...
			<div class="col-sm-12">
				<div class="box box-info">
					<div class="box-header">
						<i class="fa fa-user-plus"></i> <h3 class="box-title">Groups</h3>
						<!-- tools box -->
						<div class="pull-right box-tools">
							<a href="<?='/hrms/admin/manage-groups.php'?>" class="btn btn-primary">Go Back</a>
					...
					<div class="box-body">
						<div class="col-sm-12">
							<form id="job-titles" name="job_titles" method="post" action="" class="groups ar-forms">
